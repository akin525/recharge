        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/product')}}" aria-expanded="false"><i class="mdi mdi-cart"></i><span class="hide-menu">Reno Product <span class="badge badge-primary">Old</span> </span></a></li>
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/mcdproduct')}}" aria-expanded="false"><i class="mdi mdi-cart"></i><span class="hide-menu">Reno Product <span class="badge badge-danger">New</span> </span></a></li>
