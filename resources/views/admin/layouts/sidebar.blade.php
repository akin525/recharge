        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/renotransaction')}}" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Reno Price</span></a></li>
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/reno')}}" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Reno Transaction</span></a></li>
