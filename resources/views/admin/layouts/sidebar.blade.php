            ...
            <div class="navbar-header" data-logobg="skin5">
                ...
                <a class="navbar-brand" href="#">
                    ...
                    <span class="logo-text">
                             <!-- dark Logo text -->
{{--                        <h6 class="light-logo">Rechargestation</h6>--}}
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/switchserver')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Reno Switch</span></a></li>
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/reno')}}" aria-expanded="false"><i class="mdi mdi-book"></i><span class="hide-menu">Reno Price</span></a></li>
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/product')}}" aria-expanded="false"><i class="mdi mdi-cart"></i><span class="hide-menu">Reno Product <span class="badge badges-primary">Old</span> </span></a></li>
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin/mcdproduct')}}" aria-expanded="false"><i class="mdi mdi-cart"></i><span class="hide-menu">Reno Product <span class="badge badges-danger">New</span> </span></a></li>
